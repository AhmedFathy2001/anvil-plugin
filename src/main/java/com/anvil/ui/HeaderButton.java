...
public final class HeaderButton
{
	...
	public HeaderButton(Client client, int parentId, int anchorId, int rightOffset, String label, String action,
	...
	public HeaderButton(Client client, int parentId, int anchorId, int rightOffset, int nearOffset, String label, String action,
				 BooleanSupplier enabled, Runnable onClick)
	{
		this.client = client;
