...
public final class PersonalBests
{
	...
	public void onActivitySeen(String activity, long now)
	{
	 ...
	 */
	public boolean onChatLine(String message, long now)
	{
	 ...
	 */
	public int seed(Map<String, Integer> centisByActivity, long now)
	{
	...
	public Map<String, Integer> nextBatch()
	{
	 ...
	 */
	public void onSent(Map<String, Integer> batch)
	{
	 ...
	 */
	public void restoreState(String raw)
	{
