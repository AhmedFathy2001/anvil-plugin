 ...
 */
public final class TimedClearParser
{
	...
	public static Integer parseDurationSeconds(String message)
	{
		if (message == null)
		{
			return null;
	...
	public static boolean messageMatchesActivity(String message, String activity)
	{
		if (message == null)
		{
			return false;
	...
	public static String[] parseTrialCompletion(String message)
	{
		if (message == null)
		{
			return null;
	...
	public static String[] trialTileTarget(String activity)
	{
		String a = norm(activity);
		if (a.isEmpty())
		{
