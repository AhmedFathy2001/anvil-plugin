 ...
 */
public final class LadderMissions
{
	...
	public static boolean isLadder(String format)
	{
	 ...
	 */
	public static String valueLabel(long face, long current)
	{
		if (current == face)
		{
	 ...
	 */
	public static String countdown(String nextRevealAtIso, long nowMs)
	{
