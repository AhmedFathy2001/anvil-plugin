...
public final class ClogSync
{
	 ...
	 */
	public boolean offer(ClogPage page, long now)
	{
	...
	public List<ClogPage> nextBatch()
	{
	 ...
	 */
	public void onSent(Collection<ClogPage> batch)
	{
