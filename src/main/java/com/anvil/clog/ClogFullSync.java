 ...
 * plugin release.
 */
public final class ClogFullSync
{
	/**
	...
	public void begin(boolean manualRequest)
	{
		items.clear();
		receiving = true;
	...
	public void onItem(int itemId, int quantity, long now)
	{
	 ...
	 */
	public void onSendFailed(long now)
	{
		lastItemAt = now;
	}
