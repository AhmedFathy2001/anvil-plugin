...
public final class DeathAttribution
{
	 ...
	 */
	public synchronized void targetedUs(String name, long nowMs)
	{
	...
	public synchronized void stoppedTargetingUs(String name)
	{
		if (name != null)
		{
	...
	public synchronized void tookDamage(long nowMs)
	{
		lastDamageAt = nowMs;
	}
	 ...
	 */
	public synchronized String killer(String weWereFighting, long nowMs)
	{
	...
	public synchronized int attackerCount()
	{
